        ...
        PDFTextStripper stripper = new PDFTextStripper() {
            ...
            protected void writeString(String text, List<TextPosition> textPositions) throws IOException {
                ...
                for (int i = 0; i < textPositionList.size(); i++) {
                    ...
                    if (null == isBold) {
                        if (textPositionList.size() >= 34) {
                            isBold = 0;
                        } else if ((i + 1) < textPositionList.size()) {
        ...
        for (String s : contentSplit) {
            if (!"".equals(s)) {
                ...
                if (!"".equals(isEmpty.trim().replaceAll(" ", ""))) {
                    ...
                    if (count > 1) {
                        String prefix = s.substring(s.lastIndexOf("<font"));
                        String a1 = prefix.substring(0, prefix.indexOf(">") + 1);
                    ...
                    if (!pattern.matcher(isNum).matches()) {
                        ...
                        if (thisFontFamilySize.equals(fontFamilySize) && ((thisPadLeftNum < padLeft || (thisFontFamilySize.contains("黑体") && fontFamilySize.contains("黑体") && thisPadLeftNum != padLeft)) || ((thisPadLeftNum - padLeft) > -2))) {
